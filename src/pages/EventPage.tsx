...
export default function EventPage() {
    ...
    const { title, description, imageUrl, startDate, locationId, createdById, priceKind } = data;
        ...
        <Container className="container mx-auto max-w-6xl p-2">
            <article className="space-y-8">
                <header className="flex flex-col md:flex-row gap-6">
                    <CardMedia showHeart={false} priceKind={priceKind} src={imageUrl} className="w-full md:w-3/5 h-full" />
